...
pessoa.andar = function andar(valor) {
... pessoa.andando = true;
...
pessoa.nomeCompleto()  // 'Olá! Meu nome é Milena Carvalho!'
...
..... metros = 'metro';
..... }
... return 'Olá, eu sou ' + eleEla + ' ' + pessoa.nome + ' ' + pessoa.sobrenome + ', tenho ' + pessoa.idade + ' ' + anos + ', ' + pessoa.mostrarAltura() + ' ' + pessoa.mostrarPeso() + ' E, só hoje, eu já caminhei ' + pessoa.caminhouQuantosMetros + ' ' + metros + '!';
... }

// Agora, apresente-se ;)

pessoa.apresentacao() // 'Olá, eu sou a Milena Carvalho, tenho 27 anos, Minha altura é 1.7m. Eu peso 55Kg. E, só hoje, eu já caminhei 60 metros!'
```
